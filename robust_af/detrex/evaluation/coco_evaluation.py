...
class COCOEvaluator(ORIGINAL_COCOEvaluator):
    ...
    def _eval_predictions(self, predictions: list[dict], img_ids: list[int] = None):
        ...
        for task in sorted(tasks):
            ...
            # <<<< Beginning of code differences with original COCOEvaluator
            self._results[task] = {"instance": coco_eval, "metrics": res}
            # >>>> End of code differences with original COCOEvaluator
