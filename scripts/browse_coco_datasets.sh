...
python "$cwd/browse_coco_dataset.py" --out-dir "$out_dir" ~/data/UAV/Sim2Air/UAV-Eagle
python "$cwd/browse_coco_dataset.py" --out-dir "$out_dir" ~/data/UAV/Sim2Air/S-UAV-T
