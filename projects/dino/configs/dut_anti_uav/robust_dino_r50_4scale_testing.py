...
from .robust_dino_r50_4scale_12ep import model, train

test_dataset_name = DATASET_NAME
dataloader = get_config(f"datasets/{test_dataset_name}_detr.py").robust_dataloader

output_dir = f"./outputs/dino_r50_4scale/{DATASET_NAME}/{test_dataset_name}/robust_dino_r50_4scale_12ep_1e-4_lr_sync_bn_testing_degraded"
