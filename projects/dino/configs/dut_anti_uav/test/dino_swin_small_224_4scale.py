...
output_dir = f"./outputs/dino_swin_small_224_4scale/{DATASET_NAME}/{test_dataset_name}/dino_swin_small_224_4scale_24ep_1e-4_lr_warmup{suffix}"
...
if degraded:
    ...
    dataloader.test.mapper.augmentations[0].identity = False
