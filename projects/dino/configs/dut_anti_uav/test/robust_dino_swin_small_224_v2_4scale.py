...
output_dir = f"./outputs/dino_swin_small_224_4scale/{DATASET_NAME}/{test_dataset_name}/robust_dino_swin_small_224_v2_4scale_36ep_1e-5_lr_spatial_afr_relu_no_cst_loss_no_train_heads_from_24ep{suffix}"
