...
).detr_schedulers.lr_multiplier_24ep_warmup_8bs
...
train.output_dir = f"./outputs/dino_swin_small_224_4scale/{DATASET_NAME}/robust_dino_swin_small_224_v2_4scale_24ep_1e-5_lr_spatial_afr_no_train_heads_from_24ep"
...
params = dict(
    ...
    group="robust_dino_swin_small_224_v2_4scale_24ep",
)
