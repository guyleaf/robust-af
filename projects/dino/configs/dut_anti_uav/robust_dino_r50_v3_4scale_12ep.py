...
from ..models.robust_dino_r50_v3 import model
...
num_epochs = 12
eval_per_epochs = 1
output_dir = f"./outputs/dino_r50_4scale/{DATASET_NAME}/robust_dino_r50_v3_4scale_12ep_1e-5_lr_spatial_afr_weight_test_no_train_heads_from_36ep"
...
model.backbone.robust_module = L(build_module_dict)(
    res3=L(SpatialAFR)(embed_dims=512, affine=False),
    res4=L(SpatialAFR)(embed_dims=1024, affine=False),
    res5=L(SpatialAFR)(embed_dims=2048, affine=False),
)
