...
dataloader.test.dataset.names = f"{DATASET_NAME}_val_mixed"
dataloader.train_test.mapper.augmentations[0].identity = True
...
train.output_dir = f"./outputs/dino_r50_4scale/{DATASET_NAME}/robust_dino_r50_v2_4scale_50ep_1e-5_lr_spatial_afr_relu_no_train_heads_from_24ep_mixed_selection"
