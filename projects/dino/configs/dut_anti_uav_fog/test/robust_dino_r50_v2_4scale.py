...
dataset = get_config(f"datasets/{test_dataset_name}_fog_detr.py")
if degraded:
...
output_dir = f"./outputs/dino_r50_4scale/{DATASET_NAME}_fog/{test_dataset_name}_fog/robust_dino_r50_v2_4scale_50ep_1e-5_lr_spatial_afr_relu_no_train_heads_from_24ep{suffix}"
